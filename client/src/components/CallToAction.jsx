...
const CallToAction = () => {
  return (
    <div className="flex items-center  w-fullflex-col border border-teal-500 p-4 rounded-tl-2xl rounded-bl-none rounded-tr-none rounded-br-2xl  text-center  mx-auto gap-6 lg:flex-row">
